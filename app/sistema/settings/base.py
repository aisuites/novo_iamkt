...
N8N_WEBHOOK_GERAR_POST = config('N8N_WEBHOOK_GERAR_POST', default='')
N8N_WEBHOOK_GERAR_IMAGEM = config('N8N_WEBHOOK_GERAR_IMAGEM', default='')
# Brandguide (Fase 3): analise IA do PDF convertido
N8N_WEBHOOK_ANALYZE_BRANDGUIDE = config('N8N_WEBHOOK_ANALYZE_BRANDGUIDE', default='')
