...
N8N_WEBHOOK_COMPILA_SEM_SUGEST = config('N8N_WEBHOOK_COMPILA_SEM_SUGEST', default='')
N8N_WEBHOOK_COMPILA_COM_SUGEST = config('N8N_WEBHOOK_COMPILA_COM_SUGEST', default='')
