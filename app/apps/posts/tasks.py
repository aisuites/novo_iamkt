...
# =============================================================================
# PIPELINE SIMPLES (v2): as tasks vivem em tasks_simple.py (isolamento).
# Reimportadas aqui para que o autodiscovery do Celery (que importa este
# modulo) as registre. Helpers compartilhados acima sao usados via import lazy.
# =============================================================================
...
# Pipeline EXCLUSIVO da Thermomix (org slug='thermomix', v3-nativo): idem.
from apps.posts.tasks_thermomix import generate_post_thermomix_task  # noqa: E402,F401
